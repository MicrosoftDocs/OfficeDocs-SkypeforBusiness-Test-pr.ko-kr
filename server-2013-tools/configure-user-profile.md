...
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/JJ945594(v=OCS.15)
ms:contentKeyID: 52057012
ms.date: 08/03/2014
...
7.  In **Account Domain**, type the Active Directory 도메인 서비스 domain logon.
...
2.  In **UC/PSTN Gateway**, specify a value for Load Level. If you select a load level other than **Disabled**, you must supply a value for **PSTN Area Code** by clicking the **Add** button under Mediation Server and PSTN. Verify that you have a route configured for that area code.
    ...
    > [!NOTE]
    > You can use either the Lync Server 제어판 or the Lync Server 관리 셸 to verify voice route configuration.
