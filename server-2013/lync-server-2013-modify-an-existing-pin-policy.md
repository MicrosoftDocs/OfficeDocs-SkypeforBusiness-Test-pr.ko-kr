---
title: 기존 PIN 정책 수정
TOCTitle: 기존 PIN 정책 수정
ms:assetid: 517caaee-3349-4fa6-8d86-e4da3258a445
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Gg520993(v=OCS.15)
ms:contentKeyID: 49303631
ms.date: 08/10/2015
...
**PIN 정책** 탭을 사용하면 IP 전화를 사용하여 Lync 2013에 연결하는 사용자에게 PIN(개인 ID 번호) 인증을 제공합니다. PIN 인증을 사용하려면 웹 서비스 설정에서 **PIN 인증 사용**이 선택되어 있는지 확인합니다. 자세한 내용은 [기존 웹 서비스 구성 설정 수정](lync-server-2013-modify-existing-web-service-configuration-settings.md)을 참조하십시오.
