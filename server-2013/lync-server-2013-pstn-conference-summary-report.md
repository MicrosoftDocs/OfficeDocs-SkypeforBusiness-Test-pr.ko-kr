---
title: 'Lync Server 2013: PSTN 회의 요약 보고서'
TOCTitle: PSTN 회의 요약 보고서
ms:assetid: 8e2f0862-4dfa-4c2b-bf8d-ad71419f15d2
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Gg615014(v=OCS.15)
ms:contentKeyID: 49304338
ms.date: 08/24/2015
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Lync Server 2013의 PSTN 회의 요약 보고서

 

_**마지막으로 수정된 항목:** 2015-03-09_

Microsoft Lync Server 2013에서 PSTN 전화 회의는 한 명 이상의 참가자가 PSTN(공중 전화망) 전화를 사용해서 오디오 부분에 전화 접속하는 회의입니다. PSTN 전화는 "일반 전화", 휴대폰 또는 VoIP(Voice over IP)를 사용하지 않는 모든 전화기일 수 있습니다. 모니터링 보고서에서는 PSTN 전화 회의로 표시되더라도 이러한 회의는 보다 일반적으로 전화 접속 회의로 알려져 있습니다.
...
## PSTN 전화 회의 요약 보고서의 모범 사례 만들기

전화 접속 사용자를 포함하는 모든 회의 비율을 확인하려면 총 PSTN 전화 회의 메트릭의 값을 [Lync Server 2013의 회의 요약 보고서](lync-server-2013-conference-summary-report.md)에서 발견된 총 회의 메트릭과 비교합니다.
