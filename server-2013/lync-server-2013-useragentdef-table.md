---
title: Lync Server 2013의 UserAgentDef 테이블
TOCTitle: Lync Server 2013의 UserAgentDef 테이블
ms:assetid: 96c49239-d999-4045-8b64-9d1940cce8ff
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/JJ205100(v=OCS.15)
ms:contentKeyID: 49304452
ms.date: 08/24/2015
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Lync Server 2013의 UserAgentDef 테이블

 

_**마지막으로 수정된 항목:** 2015-03-09_

UserAgentDef 테이블은 사용자 에이전트 식별자를 에이전트의 설명이 포함된 이름에 매핑합니다. 사용자 에이전트는 Microsoft Lync Server 2013에 연결하는 데 사용되는 소프트웨어 클라이언트입니다. 이 테이블은 Microsoft Lync Server 2013에서 도입되었습니다.
