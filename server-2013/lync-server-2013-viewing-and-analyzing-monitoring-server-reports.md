...
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dn720332(v=OCS.15)
ms:contentKeyID: 62221651
ms.date: 08/10/2015
...
2.  Open a browser window, and then enter the Admin URL to open the Lync Server 제어판.
