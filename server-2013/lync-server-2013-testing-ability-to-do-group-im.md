...
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dn743839(v=OCS.15)
ms:contentKeyID: 62279288
ms.date: 08/24/2015
...
To run this check using actual user accounts, you must create two Lync Server 관리 셸 credentials objects (objects that contain the account name and password) for each account. You must then include those credentials objects and the SIP addresses of the two accounts when you call Test-CsGroupIM:
