...
자세한 내용은 [New-CsMobilityPolicy](https://docs.microsoft.com/en-us/powershell/module/skype/New-CsMobilityPolicy) 및 [Set-CsMobilityPolicy](set-csmobilitypolicy.md) cmdlet 관련 도움말 항목을 참조하십시오.
