---
title: 'Lync Server 2013: 오류 분포 보고서'
TOCTitle: 오류 분포 보고서
ms:assetid: 365c7beb-24d4-40f5-92e7-4978b9688916
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Gg558635(v=OCS.15)
ms:contentKeyID: 49303289
ms.date: 08/10/2015
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Lync Server 2013의 오류 분포 보고서
...
**예상 오류량** 또는 **예기치 않은 오류량** 메트릭을 클릭하여 다음 보고서 중 하나에서 실패 분포 보고서에 액세스할 수 있습니다.
  ...
  - [Lync Server 2013의 회의 진단 보고서](lync-server-2013-conference-diagnostic-report.md)

  - [Lync Server 2013의 피어 투 피어 활동 진단 보고서](lync-server-2013-peer-to-peer-activity-diagnostic-report.md)

실패 분포 보고서에서 다음 메트릭 중 하나를 클릭하면 [Lync Server 2013의 오류 목록 보고서](lync-server-2013-failure-list-report.md)를 볼 수 있습니다.
...
<td><p><strong>순위</strong></p></td>
<td><p>아니요</p></td>
<td><p>세션이 수행된 등록자 풀 또는 에지 서버를 기반으로 하는 실패한 세션의 상대적 순위입니다.</p></td>
</tr>
<tr class="even">
...
<td><p><strong>세션</strong></p></td>
<td><p>아니요</p></td>
<td><p>등록자 풀 또는 에지 서버당 실패한 총 세션 수입니다.</p></td>
</tr>
</tbody>
</table>
...
다음 표에서는 대부분의 오류가 발생한 Microsoft Lync Server 2010 구성 요소에 따라 오류 분포 보고서에 제공된 정보를 보여 줍니다.
...
<td><p><strong>순위</strong></p></td>
<td><p>아니요</p></td>
<td><p>Lync Server 2010 구성 요소를 기반으로 하는 실패한 세션의 상대적 순위입니다(예: ExumRouting, GroupChat, MediationServer).</p></td>
</tr>
<tr class="even">
