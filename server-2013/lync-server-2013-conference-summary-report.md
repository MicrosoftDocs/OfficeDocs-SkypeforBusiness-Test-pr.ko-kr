---
title: 'Lync Server 2013: 회의 요약 보고서'
TOCTitle: 회의 요약 보고서
ms:assetid: 62f54812-5700-45a3-8526-8f58b0f77fbc
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Gg558656(v=OCS.15)
ms:contentKeyID: 49303828
ms.date: 08/24/2015
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Lync Server 2013의 회의 요약 보고서

 

_**마지막으로 수정된 항목:** 2015-03-09_

회의 요약 보고서에서는 온라인 회의 세션에 대한 전반적인 보기를 제공합니다. 회의에는 일반적으로 2명 이상의 사용자가 포함되며 Microsoft Lync Server 2013 회의 서비스를 사용해야 합니다. 비교적 피어 투 피어 세션에서는 일반적으로 사용자가 2명만 포함되며 Lync Server의 회의 서비스를 사용할 필요가 없습니다. 피어 투 피어 활동은 [Lync Server 2013의 피어 투 피어 활동 요약 보고서](lync-server-2013-peer-to-peer-activity-summary-report.md)에서 보고됩니다.

회의 요약 보고서에는 특정 기간(시간별, 일별, 주별, 월별) 동안 진행된 회의 개수뿐만 아니라 해당 회의에 참가한 총 사용자 수 및 고유한 회의 이끌이 총 수가 표시됩니다.
...
## 회의 요약 보고서의 모범 사례 만들기

회의 요약 보고서에 사용된 대부분의 메트릭에 대한 총 값은 보고서 아래에서 찾을 수 있습니다. 지정된 기간 동안 수행된 총 회의 수 및 이러한 회의에 참가한 총 사용자 수와 같은 값을 보려면 아래로 스크롤합니다. 보고서 아래에 합계로 표시되지 않는 메트릭은 총 고유한 회의 이끌이입니다. 왜 그럴까요? 이유가 있습니다. 1개월 분량의 데이터를 조사한다고 가정해 보겠습니다. 1일째에는 고유한 회의 이끌이 수가 34명이고, 2일째에는 고유한 회의 이끌이 수가 27명입니다. 그러면 이 이틀 동안의 고유한 회의 이끌이 수는 61명일까요? 반드시 그렇지는 않을 것입니다. 2일째에 회의를 주최한 27명이 모두 그 전날에 회의를 주최한 34명에 포함될 수도 있습니다. 예를 들어 여기에 표시된 간단한 보고서에서도 Ken Myer와 Pilar Ackerman은 7/7/2012 및 7/2/2012에 회의를 예약했습니다.
...
<p>시작 및 종료 날짜가 선택한 간격에 허용되는 최대 값 수를 초과하면 시작 날짜로부터 최대 값 수만 표시됩니다. 예를 들어 일별 간격을 선택하는 경우 시작 날짜가 7/7/2012이고 종료 날짜가 2/28/2012 이면 8/7/2012 12:00 AM 부터 9/7/2012 12:00 AM 까지 총 31일의 데이터만 표시됩니다.</p></td>
</tr>
</tbody>
</table>
...
<td><p>아니요</p></td>
<td><p>필터 도구 모음에서 선택한 시간 간격을 나타냅니다. 적용 가능한 경우 제공된 시간 간격을 클릭하여 해당 간격에 대한 세부 정보를 볼 수 있습니다. 예를 들어 일별 간격을 사용 중이고 7/7/2012을 클릭하면 해당 날짜의 사용자 등록 활동에 대한 시간별 세부 내역을 볼 수 있습니다.</p></td>
</tr>
<tr class="even">
...
<p>총 A/V 회의 시간 메트릭은 A/V 회의, IM 회의, 앱 공유 회의, 데이터 회의, PSTN 회의를 포함하는 모든 오디오/시각 회의 유형을 요약합니다.</p></td>
</tr>
<tr class="odd">
