...
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/Dn720325(v=OCS.15)
ms:contentKeyID: 62221646
ms.date: 08/10/2015
...
Capacity and availability measurements are repetitive tasks that are ideally suited to automated tools and scripts such as Microsoft System Center Operations Manager(이전 Microsoft Operations Manager), which is discussed later in this document.
