---
title: 'Lync Server 2013: 인증서 요약 - 공용 IP 주소의 단일 통합 에지'
TOCTitle: 인증서 요약 - 공용 IP 주소의 단일 통합 에지
ms:assetid: 25b8ae7a-e5a0-43c0-92ae-7e144d5e4a36
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/JJ204747(v=OCS.15)
ms:contentKeyID: 49303083
ms.date: 08/10/2015
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Lync Server 2013의 인증서 요약 - 공용 IP 주소의 단일 통합 에지
...
## 공용 IP 주소를 포함하는 단일 통합 에지에 필요한 인증서
